...
If our main goal in this analysis is to increase ridership within census tracts, we need to first determine what ridership actually means. As a team we decided that we should use the amount of time measured in duration of ride (in minutes). 
